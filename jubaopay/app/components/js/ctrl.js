...
angular.module('controllers', ['ui.bootstrap', 'ngAnimate'])
    .controller('controllers', function($scope, $http, $uibModal) {
        $scope.downloadRecord = [{
            ...
            "note": "WAP支付",
            "class": "icon-java",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/java-wap-demo.zip"
        }, {
            "name": "JAVA包",
            "note": "PC端",
            "class": "icon-java",
            ...
            "note": "WAP支付",
            "class": "icon-windows",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/aspx-wap-demo.zip"

        },  {
            "name": ".NET包",
            "note": "PC端",
            "class": "icon-windows",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/aspx-demo.zip"

        },{
            "name": "PHP包",
            "note": "WAP支付",
            "class": "icon-php",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/php-demo.zip"
        }, {
            "name": "PHP包",
            "note": "PC端",
            "class": "icon-php",
            ...
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/cocos-demo.zip"
        }, {
            "name": "IOS包",
            "note": "SDK开发包",
            "class": "icon-ios",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/ios_sdk.zip"
        }, {
            "name": "Andorid",
            "note": "SDK开发包",
            "class": "icon-iconanzhuo",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/new-sdk-demo.zip"
        }, {
            "name": "商户文档",
            "note": "下载接入文档",
            "class": "icon-iconshtjrz",
            "url":"http://fwstatic.oss-cn-hangzhou.aliyuncs.com/project/jubaopay/res/sdk/jubaopay-guide.pdf"
        }];
        $scope.paymentRecord = [{
            "name": "支付宝",
            "note": "移动支付",
